            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <p className="font-bold text-xl" style={{ color: '#ffffff' }}>
                  ¢{new Intl.NumberFormat('en-US', { minimumFractionDigits: 2 }).format(combinedTotal.initialBalance)}
                </p>
              </div>
              <div>
                <p style={{ color: 'rgba(255, 255, 255, 0.5)', fontSize: '11px', marginBottom: '6px', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
                ...
                >
                  ...
                  {combinedTotal.periodProfitLoss >= 0 ? '+' : ''}
                  ¢{new Intl.NumberFormat('en-US', { minimumFractionDigits: 2 }).format(combinedTotal.periodProfitLoss)}
                </p>
              </div>
              <div>
                <p style={{ color: 'rgba(255, 255, 255, 0.5)', fontSize: '11px', marginBottom: '6px', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
                ...
                <p className="font-bold text-xl" style={{ color: '#ffffff' }}>
                  ¢{new Intl.NumberFormat('en-US', { minimumFractionDigits: 2 }).format(combinedTotal.periodBalance)}
                </p>
              </div>
            </div>
          </div>
